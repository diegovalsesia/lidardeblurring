#### this code is copied from https://github.com/pp00704831/Stripformer-ECCV-2022-/blob/main/models/Stripformer.py
...
class CatStripformer(nn.Module):
    def __init__(self):
        super(CatStripformer, self).__init__()
    ...
    def forward(self, x, dep):
        ...
        x_cat = torch.cat((x,dep),dim=1)

        hx, residual_1, residual_2 = self.encoder(x_cat)
